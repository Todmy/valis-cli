 ...
 * (per-prompt augmentation). Phase B stubs: pre-tool-use, pre-compact,
 * stop, post-tool-use (silent-skip; activate when the corresponding
 * telemetry triggers per research.md R-14).
 *
